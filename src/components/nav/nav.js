	...
	localStorage.clear();
	 ...
	 return (
	    ...
	    <header className="header dark-bg">
	      ...
	      <Link to='/' className="logo">Nice <span className="lite">Admin</span></Link>
	        ...
	        <ul className="nav pull-right top-menu">
	            ...
	            <ul className="dropdown-menu extended tasks-bar">
	              ...
	              <li>
	                <a href="#">
	                  ...
	                  <div className="progress progress-striped">
	                    <div className="progress-bar progress-bar-success" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style={progressStyle90}>
	              ...
	              <li>
	                <a href="#">
	                  ...
	                  <div className="progress progress-striped">
	                    <div className="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style={progressStyle30}>
	              ...
	              <li>
	                <a href="#">
	                  ...
	                  <div className="progress progress-striped">
	                    <div className="progress-bar progress-bar-info" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style={progressStyle80}>
	              ...
	              <li>
	                <a href="#">
	                  ...
	                  <div className="progress progress-striped">
	                    <div className="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100" style={progressStyle78}>
	              ...
	              <li>
	                <a href="#">
	                  ...
	                  <div className="progress progress-striped active">
	                    <div className="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style={progressStyle50}>
	          ...
	          <li className="dropdown">
	            <a data-toggle="dropdown" className="dropdown-toggle" href="#">
	                            ...
	                            <span className="username">{localStorage.getItem('firstName')} {localStorage.getItem('lastName')}</span>
	                            <b className="caret"></b>
	                        </a>
	            <ul className="dropdown-menu extended logout">
	              ...
	              <li>
	                <Link  onClick={e=>this.logoutHandler(e)}><i className="icon_key_alt"></i> Log Out</Link>
	              </li>
	              <li>
